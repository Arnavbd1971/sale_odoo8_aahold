...
Example: 10% for retailers, promotion of 5 EUR on this product, etc."""),
        ...
        'module_sale_margin': fields.boolean("Display margins on Proforma Invoices",
        ...
        'module_sale_stock': fields.boolean("Trigger delivery orders automatically from Proforma Invoices",
...
class account_config_settings(osv.osv_memory):
    ...
    _columns = {
        ...
        'group_analytic_account_for_sales': fields.boolean('Analytic accounting for sales',
            ...
            help="Allows you to specify an analytic account on Proforma Invoices."),
    }
